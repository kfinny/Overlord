...
option(OVERLORD_THIRD_PARTY_SOURCE_MODULE_WARNINGS "This option can be enable to show all warnings in the source modules. Not recommended" OFF)
option(OVERLORD_DISABLE_SHALLOW_CLONE "Set this option to ON to do a full git clone. For Development only" OFF)
...
function(initializeGitSubmodule submodule_path no_recursive shallow)
  ...
  if(NOT OVERLORD_DISABLE_SHALLOW_CLONE AND shallow)
...
function(importSourceSubmodule)
  ...
  foreach(submodule_to_patch ${ARGS_PATCH})
    ...
    set(OVERLORD_${library_name}_ROOT_DIR "${patched_source_dir}")
  ...
  if(NOT OVERLORD_THIRD_PARTY_SOURCE_MODULE_WARNINGS)
    if(DEFINED PLATFORM_POSIX)
      target_compile_options(overlord_thirdparty_extra_c_settings INTERFACE
        -Wno-everything -Wno-all -Wno-error
      )
      target_compile_options(overlord_thirdparty_extra_cxx_settings INTERFACE
        -Wno-everything -Wno-all -Wno-error
      )
