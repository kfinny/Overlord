...
set(OVERLORD_FORMULA_INSTALL_DIRECTORY "${CMAKE_BINARY_DIR}/installed_formulas")

set(OVERLORD_FORMULA_BUILD_JOBS 4 CACHE STRING "Numer of parallel jobs that will be used for each third party library which uses the formula system to build")
...
function(importFormula library_name)
  ...
  set(install_prefix "${OVERLORD_FORMULA_INSTALL_DIRECTORY}/${library_name}")

  getCompilationFlags(c OVERLORD_FORMULA_CFLAGS)
  getCompilationFlags(cxx OVERLORD_FORMULA_CXXFLAGS)
